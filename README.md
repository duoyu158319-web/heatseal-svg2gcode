...
[![Check web app](https://github.com/duoyu158319-web/heatseal-svg2gcode/actions/workflows/web.yml/badge.svg)](https://github.com/duoyu158319-web/heatseal-svg2gcode/actions/workflows/web.yml)
[![Deploy website](https://github.com/duoyu158319-web/heatseal-svg2gcode/actions/workflows/web-deploy.yml/badge.svg)](https://github.com/duoyu158319-web/heatseal-svg2gcode/actions/workflows/web-deploy.yml)

一个在浏览器中把 SVG 轨迹转换为热封工艺 G-code 的工具。

- 按独立 SVG Stroke 输出完整热封周期，可调悬停时间、温度和工作高度。
- 多个 SVG 按拖入顺序合并为一个 G-code 文件。
- 支持用 SVG 生成的 G-code 替换模板 G-code 中包含“标记”的整行。
- 保留原版 SVG 解析、尺寸、DPI、曲线离散、路径优化和轨迹预览逻辑。
...
Open <https://duoyu158319-web.github.io/heatseal-svg2gcode/>, select one or more SVG files, configure the heat-seal parameters, and click generate.
